# Step 26.3.0 — Phase 26 Explorer Links and Public Legal Links

## Goal

Add safe explorer links plus privacy/terms links without hardcoded production secrets.
...
- Render transaction/address explorer links only from configured public explorer base URLs.
- Sanitize/validate URL construction and avoid rendering malformed links.
- Add configurable or documented privacy/terms links with safe defaults if the config model supports it; otherwise document operator placement without inventing runtime config.
- Update configuration and deployment docs.
- Add tests for missing explorer URL, tx hash rendering, and unsafe/malformed values.
...
Recommended branch name: `phase-26.3-26-explorer-links-public-legal-links`.
