# Step 30.1.0 — Phase 30 Wallet Integration Inventory and Contract Plan

## Goal

Audit current wallet/public API behavior and define the SCAVIUM Wallet contract.
...
- Inventory wallet/status endpoints, token config, CORS/origin handling, frontend contracts, and docs.
- Define wallet-specific endpoints and challenge strategy with backward compatibility.
- Identify app-origin policy requirements without hardcoding production origins or secrets.
- Do not implement signature verification until the challenge contract is documented.
...
Recommended branch name: `phase-30.1-30-wallet-integration-inventory-contract-p`.
