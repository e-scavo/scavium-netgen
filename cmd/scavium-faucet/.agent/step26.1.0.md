# Step 26.1.0 — Phase 26 Frontend Inventory and UX Contract

## Goal

Audit current HTML/JS frontend and define the minimal Phase 26 UX changes.
...
- Read `cmd/scavium-faucet/web/index.html`, frontend package tests, public API docs, and CSP/security docs.
- Identify the existing token selector, claim result flow, maintenance-mode rendering, and any JS/CSS structure.
- Decide the smallest sequence for status/history UX, explorer links, privacy/terms links, accessibility, and mobile polish.
- Do not implement large visual rewrites or embed scripts into Go.
...
Recommended branch name: `phase-26.1-26-frontend-inventory-ux-contract`.
