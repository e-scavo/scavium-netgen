# Step 30.3.0 — Phase 30 Optional Wallet Signature Verification

## Goal

Add optional wallet signature verification without making legacy claim clients fail.
...
- Verify signatures using existing crypto dependencies if available; do not add heavy dependencies.
- Keep the challenge optional or gated as documented so existing clients remain compatible.
- Validate address/signature/challenge at service/domain boundaries.
- Add tests for valid signature, wrong signer, expired challenge, replay, malformed payloads, and legacy path.
...
Recommended branch name: `phase-30.3-30-optional-wallet-signature-verification`.
