# Step 29.1.0 — Phase 29 Campaign and Allowlist Design Audit

## Goal

Audit allowlist/campaign needs and design the minimal schema/API sequence.
...
- Read Phase 28 output, admin persistence, claim validation, abuse, metrics, and docs.
- Define campaign budgets, allowlist scopes, invitation codes, CSV export, and admin visibility boundaries.
- Do not implement all campaign behavior in one step; split schema, enforcement, admin controls, and exports.
...
Recommended branch name: `phase-29.1-29-campaign-allowlist-design-audit`.
