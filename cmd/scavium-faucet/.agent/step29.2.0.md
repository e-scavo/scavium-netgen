# Step 29.2.0 — Phase 29 Campaign and Allowlist Persistence

## Goal

Add durable campaign, allowlist, and invitation-code persistence primitives.
...
- Add migrations and store methods for campaigns, allowlist scopes, invitation codes, and budget counters as minimally required.
- Keep schema idempotent and indexed for production queries.
- Do not activate enforcement until service logic and tests are ready.
- Add migration/store tests and docs.
...
Recommended branch name: `phase-29.2-29-campaign-allowlist-persistence`.
