# Step 30.4.0 — Phase 30 App-Origin Policy and Wallet UX Examples

## Goal

Add app-origin policy handling and wallet UX contract examples.
...
- Add app-origin checks only where they are meaningful defense-in-depth and configurable.
- Do not rely on Origin as sole security control.
- Update public docs with wallet flow examples, challenge examples, and frontend/client integration guidance.
- Add tests for allowed origin, denied origin, missing origin, and operator configuration defaults where applicable.
...
Recommended branch name: `phase-30.4-30-app-origin-policy-wallet-ux-examples`.
