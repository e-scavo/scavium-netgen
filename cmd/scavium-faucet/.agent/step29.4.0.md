# Step 29.4.0 — Phase 29 Admin Campaign Controls and CSV Export

## Goal

Add protected admin controls and CSV export for campaign operations.
...
- Add admin-protected create/update/list/disable controls only for the minimal campaign model.
- Audit-log all mutations.
- Add CSV export using safe standard-library generation; prevent CSV injection where user-controlled fields appear.
- Add tests for auth, audit, pagination/export limits, and CSV safety.
- Update admin/runbook docs.
...
Recommended branch name: `phase-29.4-29-admin-campaign-controls-csv-export`.
