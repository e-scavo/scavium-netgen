# Step 27.1.0 — Phase 27 Anti-Abuse Inventory and Risk Model Plan

## Goal

Audit current abuse enforcement and design the smallest advanced anti-abuse increments.
...
- Read abuse, faucet, httpapi, store, metrics, docs, and migrations before designing changes.
- Inventory persisted abuse signals and current progressive enforcement.
- Define bounded risk-score additions, burst detection, rotating IP heuristics, address clustering, optional honeypot/JS challenge, and manual-review boundaries.
- Do not implement schema changes until the exact migration and rollback implications are clear.
...
Recommended branch name: `phase-27.1-27-anti-abuse-inventory-risk-model-plan`.
